...
const routing = _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forRoot(APP_ROUTES);
...
let ListarTechshotsService = class ListarTechshotsService {
    constructor(http) {
        this.http = http;
...
let ListarTechshotsComponent = class ListarTechshotsComponent {
...
let VotarTechshotsComponent = class VotarTechshotsComponent {
    constructor(listarTechshotsService) {
        this.listarTechshotsService = listarTechshotsService;
    }
    ngOnInit() {
